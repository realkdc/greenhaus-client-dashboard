...
export const metadata: Metadata = {
  title: "Ambassadors Dashboard | GreenHaus Admin",
};

export default function AmbassadorsPage(): JSX.Element {
  return (
    <RequireAuth>
      ...
      <div className="w-full max-w-3xl rounded-3xl border border-slate-200/80 bg-white/90 p-12 text-center shadow-lg shadow-accent/5">
        <span className="accent-pill mb-4">Community</span>
        <h1 className="text-4xl font-semibold text-slate-900">
          Ambassadors Dashboard
        </h1>
        <p className="mt-4 text-base text-slate-600">
          Prepare a future-ready portal for the GreenHaus crew and affiliate
          partners.
        </p>
      </div>
    </section>
